    ...
    return (
        <nav>
            <div className="flex justify-between items-center px-[4rem] py-[1rem] border-b border-b-slate-900 fixed top-0 left-0 w-full">
                <div className="nav_brand text-2xl font-bold text-slate-900">
                    <h2>Search<span className="text-red-500">Book</span></h2>
                </div>

                <div className="search_bar_container flex items-center w-[25rem] bg-white px-[1rem] border border-slate-300 rounded-lg ">
